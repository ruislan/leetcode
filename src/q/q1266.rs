...
fn test_q1266() {
    ...
    assert_eq!(5, Solution::min_time_to_visit_all_points(vec![vec![3, 2], vec![-2, 2]]));
    assert_eq!(10, Solution::min_time_to_visit_all_points(vec![vec![3, 2], vec![-2, 2], vec![3, 2]]));
    assert_eq!(1004, Solution::min_time_to_visit_all_points(vec![vec![-2, 0], vec![-2, 2], vec![-2, -1000]]));
}